          ...
          <div className="flex flex-col items-center mt-5 w-full">
            ...
            >
              <input
                type="email"
                placeholder="Email"
                className="border-2 border-gray-300 bg-gray-50 rounded-lg p-2 w-full sm:w-80 text-black"
                value={email}
              ...
              <div className="relative w-full sm:w-80">
                <input
                  ...
                  className="border-2 border-gray-300 bg-gray-50 rounded-lg p-2 w-full pr-10 text-black"
                  value={password}
